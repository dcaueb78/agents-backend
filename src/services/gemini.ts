...
export async function generateAnswer(
  ...
  const prompt = `
    ...
    - Se a resposta não for encontrada no contexto, apenas responda que não possui informações suficientes para respondes;
    - Seja objetivo;
  ...
  if (!response.text) {
    throw new Error('Falha ao gerar respost pelo Gemini')
  }
